...
Which brings us to maintenance – a well-developed site should be simple for clients to update and maintain with minimal programming knowledge. I don't believe that a client should have to rely on a developer to make minor changes to their site, and I implement that philosophy through highly configurable templating.
